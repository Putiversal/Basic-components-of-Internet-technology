...
namespace Delegates
{
    ...
    //    public int Gun_powder { get => gun_powder; set => gun_powder = value; }
    //    public double Mixture { get => mixture; set => mixture = value; }
    //    public double Boom { get => boom; set => boom = value; }
    //}

    delegate double Expl_BS(int p1, double p2);

    class Program
    {
        //Методы, реализующие делегат (методы "типа" делегата)
        static double Big(int p1, int p2) { return p1 * p2; }
        static double Small(int p1, int p2) { return p1 + p2; }

        /// <summary>
        /// Использование обощенного делегата Func<>
        /// </summary>
        static void BigOrSmallMethodFunc(string str, int i1, double i2, Func<int, double, double> Expl_BS)
        {
            int Result = Expl_BS(i1, i2);
        ...
        static void Main(string[] args)
        {
            ...
            PlusOrMinusMethod("Создание экземпляра делегата на основе анонимного метода: ", i1, i2, pm3); // Question pm2
